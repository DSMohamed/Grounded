  ...
  if (collapsed) {
    return (
      <aside className="flex w-16 flex-col items-center border-r border-border/40 bg-[var(--sidebar-bg)] py-4">
        ...
        <button
          onClick={onNew}
          className="flex size-10 items-center justify-center rounded-lg text-muted-foreground hover:bg-evidence/10 hover:text-evidence"
        >
  ...
  return (
    <aside className="flex w-64 flex-col border-r border-border/40 bg-[var(--sidebar-bg)]">
      ...
      <div className="px-3 py-3">
        <button
          onClick={onNew}
          className="flex w-full items-center gap-2 rounded-lg border border-border/40 bg-card/30 px-3 py-2.5 font-mono text-[12px] text-muted-foreground transition-colors hover:bg-evidence/10 hover:text-evidence hover:border-evidence/30"
        >
